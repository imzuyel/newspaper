...
<section class="content">
    ...
    <div class="container-fluid">
        <ol class="breadcrumb breadcrumb-col-pink ">
            <li><a href="{{ route('admin.tag.index') }}"> <i class="material-icons">label</i>Tag</a></li>
        </ol>
        <!-- Exportable Table -->
        <div class="row clearfix">
            <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 ">
                <div class="card">
                    <div class="header">
                        <h3>Tag Control <span><a class="btn bg-success btn-success waves-float" data-toggle="modal"
                                    data-target="#addTag">
                                    Add
                                </a></span></h3>
                    </div>
                    <div class="body">
                        <div class="table col-lg-offset-2 table-responsive text-center">
                            <table
                                class="table-bordered table-striped table-hover @if(count($tags)>0) dataTable js-exportable @endif">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($item->status==1)
                                            <a href="{{ route('admin.tag.unpublished',$item->id) }}"
                                            ...
                                            @else
                                            <a href="{{ route('admin.tag.published',$item->id) }}"
                                            ...
                                            <a class="btn bg-success btn-info btn-circle waves-effect waves-circle waves-float"
                                                data-toggle="modal" data-target="#editTag" data-id="{{ $item->id }}"
                                                data-name="{{ $item->name }}">
...
@include('backend.admin.tag.create')
